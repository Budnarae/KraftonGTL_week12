#include "pch.h"
#include "FParticleViewerViewportClient.h"
#include"CameraActor.h"
#include "World.h"

FParticleViewerViewportClient::FParticleViewerViewportClient()
{
...
void FParticleViewerViewportClient::Draw(FViewport* Viewport)
{
...
void FParticleViewerViewportClient::Tick(float DeltaTime)
{
    // Reuse base behavior (camera input, wheel, clipboard shortcuts)
    FViewportClient::Tick(DeltaTime);
}

void FParticleViewerViewportClient::MouseMove(FViewport* Viewport, int32 X, int32 Y)
{
    FViewportClient::MouseMove(Viewport, X, Y);
}

void FParticleViewerViewportClient::MouseButtonDown(FViewport* Viewport, int32 X, int32 Y, int32 Button)
{
    FViewportClient::MouseButtonDown(Viewport, X, Y, Button);
}

void FParticleViewerViewportClient::MouseButtonUp(FViewport* Viewport, int32 X, int32 Y, int32 Button)
{
    FViewportClient::MouseButtonUp(Viewport, X, Y, Button);
}

void FParticleViewerViewportClient::MouseWheel(float DeltaSeconds)
{
