...
public: \
    ...
    using ThisClass_t = UParticleModuleSpawn; \
    static UClass* StaticClass() \
    { \
        static UClass Cls{ "UParticleModuleSpawn", UParticleModule::StaticClass(), sizeof(UParticleModuleSpawn) }; \
        static bool bRegistered = (UClass::SignUpClass(&Cls), true); \
        return &Cls; \
    } \
    virtual UClass* GetClass() const override { return UParticleModuleSpawn::StaticClass(); } \
    UParticleModuleSpawn(const UParticleModuleSpawn&) = default; \
    UParticleModuleSpawn* Duplicate() const override \
    { \
        UParticleModuleSpawn* NewObject = ObjectFactory::DuplicateObject<UParticleModuleSpawn>(this); \
