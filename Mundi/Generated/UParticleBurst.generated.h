...
public: \
    using Super = UObject; \
    using ThisClass_t = UParticleBurst; \
    static UClass* StaticClass() \
    { \
        static UClass Cls{ "UParticleBurst", UObject::StaticClass(), sizeof(UParticleBurst) }; \
        static bool bRegistered = (UClass::SignUpClass(&Cls), true); \
        return &Cls; \
    } \
    virtual UClass* GetClass() const override { return UParticleBurst::StaticClass(); } \
    UParticleBurst(const UParticleBurst&) = default; \
    UParticleBurst* Duplicate() const override \
    { \
        UParticleBurst* NewObject = ObjectFactory::DuplicateObject<UParticleBurst>(this); \
